...
#ifndef RING_VEO_SIMPLE_RANDOM_HPP
#define RING_VEO_SIMPLE_RANDOM_HPP
...
namespace ring {
    ...
    namespace veo {
        ...
        private:
            ...
            void copy(const veo_simple_random &o) {
        ...
        public:
            ...
            veo_simple_random() = default;

            veo_simple_random(const std::vector<triple_pattern> *triple_patterns,
            ...
            //! Copy constructor
            veo_simple_random(const veo_simple_random &o) {
                copy(o);
            }

            //! Move constructor
            veo_simple_random(veo_simple_random &&o) {
                *this = std::move(o);
            }

            //! Copy Operator=
            veo_simple_random &operator=(const veo_simple_random &o) {
                if (this != &o) {
                    copy(o);
                }
                return *this;
            ...
            //! Move Operator=
            veo_simple_random &operator=(veo_simple_random &&o) {
                if (this != &o) {
